...
# Description: Modified Cho-Han game
# Changes made:
# - Updated input prompt to initials
# - Changed house percentage to 12%
# - Added bonus rule for rolls of 2 or 7
# - Implemented bonus payout logic
...
''')
print('Bonus rule: If you roll a 2 or 7, you receive a 10 mon bonus!')
...
while True:  # Main game loop.
    ...
    if diceTotal == 2 or diceTotal == 7:
        print('Bonus! You rolled a', diceTotal, 'and earned a 10 mon bonus.')
        purse += 10
